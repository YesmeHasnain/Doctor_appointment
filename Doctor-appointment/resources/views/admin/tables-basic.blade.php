        ...
        <div class="layout-page">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    class="github-button"
                    href="https://github.com/YesmeHasnain/Doctor_appointment"
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Patients /</span>Detail</h4>
                ...
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      @foreach ($data as $PatientRecord)
                      <tr>
                        <td><span class="badge bg-label-primary me-1">{{ $PatientRecord->id }}</span></td>
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>
                          {{ $PatientRecord->name }}  
                        </strong></td>
                        <td>{{ $PatientRecord->email }}</td>
                        <td>
                          <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                            <li
                              ...
                              title="Lilian Fuller"
                            >
                              <img src="../AdminAssets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                            </li>
                          </ul>
                        </td>
